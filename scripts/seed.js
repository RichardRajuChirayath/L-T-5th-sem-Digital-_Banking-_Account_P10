...
const seedData = async () => {
  try {
    ...
    console.log('[Seeder] Creating Users (Admin, Staff, Customers)...');
    // 1. Admin
    ...
    // 5. Customer 3 (Charlie - Pending Application)
    ...
    console.log('[Seeder] Creating Bank Accounts...');
    ...
    // Charlie's Account (PENDING_APPROVAL) - Ready for staff approval workflow demo!
    ...
    // An Account for demonstration of FREEZE (Frozen Account)
    const bobFrozen = await Account.create({
      ...
      freezeReason: 'Flagged for compliance verification of high foreign remittances',
      interestRate: 0,
      dailyTransferLimit: 50000
    });

    console.log('[Seeder] Recording Initial Approvals & Audits...');
    await Approval.create({
      accountId: aliceSavings._id,
      staffId: staffUser._id,
      decision: APPROVAL_DECISIONS.APPROVED,
      remarks: 'KYC verified and physical documents cross-checked against database.',
    ...
    await Approval.create({
      ...
      remarks: 'Suspicious overseas transaction audit pending. Temporary freeze initiated.',
      previousStatus: ACCOUNT_STATUS.ACTIVE,
      newStatus: ACCOUNT_STATUS.FROZEN
    });

    console.log('[Seeder] Adding Beneficiaries...');
    // Alice adds Bob as beneficiary
    ...
    console.log('[Seeder] Creating Ledger Transactions (Standard & Flagged)...');
    // 1. Initial Deposit to Alice
    await Transaction.create({
      ...
      description: 'Initial branch opening deposit',
      flagged: false,
      status: 'COMPLETED'
    });

    // 2. Normal Transfer from Alice to Bob
    ...
    await Transaction.create({
      ...
      description: `Transfer to A/C ${bobSavings.accountNumber} for Project consulting`,
      flagged: false,
      status: 'COMPLETED'
    });
    ...
    await Transaction.create({
      ...
      description: `Transfer from A/C ${aliceSavings.accountNumber} for Project consulting`,
      flagged: false,
      status: 'COMPLETED'
    });

    // 3. Suspicious / Flagged Transaction (> 50,000 threshold)
    ...
    await Transaction.create({
      ...
      description: 'Equipment Bulk Purchase (Automated AML Flag Triggered)',
      flagged: true,
    ...
    console.log('\n======================================================');
    console.log(' SEEDING COMPLETE! Test Credentials Available:');
    console.log('======================================================');
    console.log('Admin:');
    console.log('  Email:    admin@digitalbank.com');
    console.log('  Password: Password@123');
    console.log('------------------------------------------------------');
    console.log('Bank Staff:');
    console.log('  Email:    staff@digitalbank.com');
    console.log('  Password: Password@123');
    console.log('------------------------------------------------------');
    console.log('Customer (Alice Sharma - Active Accounts):');
    console.log('  Email:    alice@customer.com');
    console.log('  Password: Password@123');
    console.log('  Savings:  1008001001 (Balance: ₹75,000)');
    console.log('  Current:  1008001002 (Balance: ₹1,50,000)');
    console.log('------------------------------------------------------');
    console.log('Customer (Bob Patel - Active & Frozen Accounts):');
    console.log('  Email:    bob@customer.com');
    console.log('  Password: Password@123');
    console.log('  Savings:  1008002001 (Balance: ₹45,000)');
    console.log('  Frozen:   1008002002 (Balance: ₹12,000 - FROZEN)');
    console.log('------------------------------------------------------');
    console.log('Customer (Charlie Verma - Pending Approval Demo):');
    console.log('  Email:    charlie@customer.com');
    console.log('  Password: Password@123');
    console.log('  Pending:  1008003001 (Needs Staff Approval)');
    console.log('======================================================\n');
